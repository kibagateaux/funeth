// stripped down FeeContract. Only claims fees, transfers spigot ownership.
// 


import {Ownable} from 'solady/auth/Ownable.sol';
import {IERC20, IAaveMarket, INNETH} from "../Interfaces.sol";

contract FeeClaimer is Ownable {
