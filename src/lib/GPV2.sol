...
library GPv2Order {
    ...
    /// @dev Same across all chains because settlement address is the same.
    // TODO mixin GPv2Helper to make it chain specific to prevent replays
    ...
    struct Data {
        address sellToken; // MUST be IERC20
        address buyToken; // MUST be ERC20
        address receiver;
        uint256 sellAmount;
        uint256 buyAmount;
        uint32 validTo;
