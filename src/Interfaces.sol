...
interface IFunCityLandRegistry {
...
interface IFunFactory {
    ...
    function setFunLoanFee(uint16 _funLoanFee) external;
    function setFunCityClosingFee(uint16 _funCityClosingFee) external;

    function owner() external view returns (address);
    function funLoanFee() external view returns (uint16);
    function funCityClosingFee() external view returns (uint16);
}
